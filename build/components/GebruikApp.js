...
var debug = require('debug')('GebruikApp.js');
...
var weightSettings = [
    {
        'id': 1,
        'title': 'Riolering - rioolvreemd water ',
        'times': 3,
        'weight': 25
    },
    {
        'id': 2,
        'title': 'Riolering - potentiële verstoppingen',
        'times': 1,
        'weight': 8
    },
    {
        'id': 3,
        'title': 'Lozingen - meldingen burgers ',
        'times': 1,
        'weight': 8
    },
    {
        'id': 4,
        'title': 'Verstoppingen - meldingen burgers    ',
        'times': 5,
        'weight': 42
    },
    {
        'id': 5,
        'title': 'Riolering - meldingen vanuit de zuivering ',
        'times': 1,
        'weight': 8
    },
    {
        'id': 6,
        'title': 'Riolering - vervuilingsgraad zuivering ',
        'times': 1,
        'weight': 8
    }
];

var GebruikApp = React.createClass({
    ...
    componentDidMount: function() {
        ...
        d3.csv("static/data/data_gebruik.csv", function (csv) {
                ...
                <Row>
                    <Col md={6} xs={12} id="fixedheader" style={{margin:'0 0 10px 0'}}>
                        <h2 style={{fontSize:'2em'}}>
                            <a href="#" className="home"><i className="fa fa-arrow-circle-o-left"/></a>&nbsp;<strong>KPI Gebruik</strong>&nbsp;
...
var InfoModal = React.createClass({
  render: function() {
    return this.transferPropsTo(
        <Modal title="Gebruik" animation={true}>
